...
public class AcceleratedProcedureDto {
    ...
    @JsonCreator
    public AcceleratedProcedureDto(@JsonProperty("isAcceleratedProcedure") final Boolean isAcceleratedProcedure
                                ) {
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof AcceleratedProcedureDto)) {
            return false;
        }
        final AcceleratedProcedureDto rhs = ((AcceleratedProcedureDto) other);
