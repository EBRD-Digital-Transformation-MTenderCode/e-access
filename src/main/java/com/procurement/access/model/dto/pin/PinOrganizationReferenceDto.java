...
public class PinOrganizationReferenceDto {
    @JsonProperty("id")
    ...
    @JsonCreator
    public PinOrganizationReferenceDto(@JsonProperty("name") final String name,
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof PinOrganizationReferenceDto)) {
            return false;
        }
        final PinOrganizationReferenceDto rhs = (PinOrganizationReferenceDto) other;
