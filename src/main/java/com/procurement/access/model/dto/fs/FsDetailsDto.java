...
public class FsDetailsDto {
    ...
    @JsonCreator
    public FsDetailsDto(@JsonProperty("typeOfBuyer") final TypeOfBuyer typeOfBuyer,
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof FsDetailsDto)) {
            return false;
        }
        final FsDetailsDto rhs = (FsDetailsDto) other;
    ...
    public enum Scale {
        ...
        static {
            for (final FsDetailsDto.Scale c : values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        public static Scale fromValue(final String value) {
            final FsDetailsDto.Scale constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            }
            return constant;
    ...
    public enum TypeOfBuyer {
        ...
        static {
            for (final FsDetailsDto.TypeOfBuyer c : values()) {
                CONSTANTS.put(c.value, c);
            }
        }
