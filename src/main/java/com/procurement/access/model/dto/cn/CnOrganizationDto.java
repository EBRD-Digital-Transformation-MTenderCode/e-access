...
public class CnOrganizationDto {
    @JsonProperty("id")
    ...
    private final CnDetailsDto details;
    ...
    @JsonCreator
    public CnOrganizationDto(@JsonProperty("name") final String name,
                             ...
                             @JsonProperty("details") final CnDetailsDto details,
    ...
    public enum PartyRole {
        ...
        private static final Map<String, PartyRole> CONSTANTS = new HashMap<>();
