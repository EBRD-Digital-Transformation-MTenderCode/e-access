...
public class CnDetailsDto {
    ...
    @JsonCreator
    public CnDetailsDto(@JsonProperty("typeOfBuyer") final TypeOfBuyer typeOfBuyer,
    ...
    public enum Scale {
        ...
        static {
            for (final CnDetailsDto.Scale c : values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        public static Scale fromValue(final String value) {
            final CnDetailsDto.Scale constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            }
            return constant;
    ...
    public enum TypeOfBuyer {
        ...
        static {
            for (final CnDetailsDto.TypeOfBuyer c : values()) {
                CONSTANTS.put(c.value, c);
            }
        }
