...
public class PinPeriod {
    ...
    @JsonCreator
    public PinPeriod(@JsonProperty("startDate") final LocalDateTime startDate,
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof PinPeriod)) {
            return false;
        }
        final PinPeriod rhs = (PinPeriod) other;
