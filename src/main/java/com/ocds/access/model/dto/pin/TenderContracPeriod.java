...
public class TenderContracPeriod {
    ...
    @JsonCreator
    public TenderContracPeriod(@JsonProperty("startDate") @JsonDeserialize(using = LocalDateTimeDeserializer.class) final LocalDateTime startDate,
    ...
    public boolean equals(final Object other) {
        ...
        final TenderContracPeriod rhs = (TenderContracPeriod) other;
