...
public class LotDto {
    ...
    @Valid
    @NotNull
    private final List<RecurrentProcurementDto> recurrentProcurement;
    ...
    public LotDto(@JsonProperty("id") final String id,
                  ...
                  @JsonProperty("recurrentProcurement") final List<RecurrentProcurementDto> recurrentProcurement,
