...
public class BudgetBreakdownPeriod {
    ...
    @JsonCreator
    public BudgetBreakdownPeriod(@JsonProperty("startDate") @JsonDeserialize(using = LocalDateTimeDeserializer.class) final LocalDateTime startDate,
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof BudgetBreakdownPeriod)) {
            return false;
        }
        final BudgetBreakdownPeriod rhs = (BudgetBreakdownPeriod) other;
