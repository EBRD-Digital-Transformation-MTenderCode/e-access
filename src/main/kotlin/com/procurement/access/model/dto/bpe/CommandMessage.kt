...
val CommandMessage.operationId: String
    get() = this.context.operationId
        ?: throw ErrorException(error = ErrorType.CONTEXT, message = "Missing the 'operationId' attribute in context.")
