...
class CnServiceImpl(private val generationService: GenerationService,
    ...
    override fun createCn(stage: String,
        ...
        cn.tender.apply {
            ...
            setIdOfOrganizationReference(this.procuringEntity)
        }
    ...
    private fun setIdOfOrganizationReference(or: OrganizationReference) {
        if (or.identifier == null) throw ErrorException(ErrorType.IDENTIFIER_IS_NULL)
        or.id = or.identifier.scheme + "-" + or.identifier.id
    }
