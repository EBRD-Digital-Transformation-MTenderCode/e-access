...
class NegotiationCnOnPnService(
                        ...
                        NegotiationCnOnPnResponse.Tender.Lot(
                            ...
                            options = lot.options.map { option ->
                                NegotiationCnOnPnResponse.Tender.Lot.Option(
                                    description = option.description,
                                    period = option.period?.let { period ->
                                        NegotiationCnOnPnResponse.Tender.Lot.Period(
                                            startDate = period.startDate,
                                            endDate = period.endDate,
                                            maxExtentDate = period.maxExtentDate,
                                            durationInDays = period.durationInDays
                            ...
                            recurrence = lot.recurrence?.let { recurrence ->
                                NegotiationCnOnPnResponse.Tender.Lot.Recurrence(
                                    description = recurrence.description,
                                    dates = recurrence.dates?.map { date ->
                                        NegotiationCnOnPnResponse.Tender.Lot.Recurrence.Date(
                                            startDate = date.startDate
                                        )
                                    }
                                )
    ...
    private fun NegotiationCnOnPnRequest.Tender.Lot.checkOptions() {
    ...
    private fun NegotiationCnOnPnRequest.Tender.Lot.checkRecurrence() {
    ...
    private fun NegotiationCnOnPnRequest.Tender.Lot.checkRenewal() {
